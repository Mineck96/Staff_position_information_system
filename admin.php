...
<?php   
        ...
        <!--First change, main header was designed ie; Staff Positionsing Information System (SPIS) -->
        <div>

          <h5> STAFF POSITIONING INFORMATION SYSTEM  </h5>
        ...
        <!--Second change, header was changed from USER to STAFFS -->
        ...
        <thead>
            <tr>
              <!--Third change, some headers were added, some were removed-->
            	<th>ID</th>
                <th>NAME</th>
                <th>POSITION</th>
                <th>DATE ASSIGNED</th>              
